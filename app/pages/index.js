    ...
    return (
      <div id = "bod" className="container">
        ...
        <main  className="container pt-5">
          ...
          <div id="gs1" className="gs">
            <h2 className="">What is RPG of Life?</h2>
          ...
          <div id="gs2" className="gs">
              ...
              <p className="description mb-5">
                  When you start with your new character, your stats start off at 1.<br></br> 
                  To increase these stats, accomplish tasks that are categorized to these stats.
              </p>
            
          </div>
          <div id="gs3" className="gs">
            <h2>The Shop</h2>
